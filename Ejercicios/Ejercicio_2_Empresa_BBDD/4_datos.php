...
$consulta11 = $conexion->prepare("INSERT INTO `departamentos`(`id`, `nombre`, `presupuesto`, `sede_id`) VALUES
...
$consulta12 = $conexion->prepare("INSERT INTO `empleados` (`id`, `nombre`, `email`, `apellidos`, `salario`, `hijos`, `departamento_id`, `pais_id`) VALUES
...
$consulta13 = $conexion->prepare("INSERT INTO `paises` (`id`, `nacionalidad`, `pais`) VALUES
(1, 'Afgana', 'Afganistán'),
(2, 'Albanesa', 'Albania'),
(3, 'Alemana', 'Alemania'),
(4, 'Andorrana', 'Andorra'),
...
$consulta14 = $conexion->prepare("INSERT INTO `sedes` (`id`, `nombre`, `direccion`) VALUES
